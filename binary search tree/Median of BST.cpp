...
// find the (n/2)th node
void inorder(Node *root,int cnt, int&a,int&b,int&c){
    if(root==NULL || c >=cnt +1 ) return;
    
    inorder(root->left,cnt,a,b,c);
